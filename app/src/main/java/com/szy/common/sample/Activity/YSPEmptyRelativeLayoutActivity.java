...
public class YSPEmptyRelativeLayoutActivity extends AppCompatActivity implements EmptyViewListener {
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.activity_empty_showEmptyView:
                EmptyViewUtils.showEmptyView((RelativeLayout) findViewById(R.id.activity_root_view),
                        this);
                return true;
            case R.id.activity_empty_showOfflineView:
                EmptyViewUtils.showOfflineView(
                        (RelativeLayout) findViewById(R.id.activity_root_view), this);
                return true;
    ...
    public void onEmptyViewClicked(int type) {
        switch (ViewType.valueOf(type)) {
            case VIEW_TYPE_OFFLINE:
                EmptyViewUtils.hideEmptyView(
                        (RelativeLayout) findViewById(R.id.activity_root_view));
                break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_empty_relaitve_layout);
